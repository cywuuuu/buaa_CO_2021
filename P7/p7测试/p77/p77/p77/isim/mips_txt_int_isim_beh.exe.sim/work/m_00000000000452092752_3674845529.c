...
#endif
static const char *ng0 = "E:/Desktop/p77/p77/p77/STALL_CTRL.v";
static int ng1[] = {2, 0};
static int ng2[] = {3, 0};
static int ng3[] = {14, 0};
static int ng4[] = {0, 0};
...
LAB45:    memcpy(t197, t140, 8);

LAB46:    memset(t229, 0, 8);
    t230 = (t197 + 4);
...
LAB58:    memcpy(t152, t174, 8);

LAB59:    memset(t189, 0, 8);
    t190 = (t152 + 4);
...
LAB65:    if (*((unsigned int *)t190) != 0)
        goto LAB66;

LAB67:    t198 = *((unsigned int *)t140);
...
LAB55:    xsi_vlog_unsigned_bit_combine(t152, 5, t167, 5, t174, 5);
    goto LAB59;

LAB57:    memcpy(t152, t167, 8);
    goto LAB59;
...
LAB79:    if (*((unsigned int *)t241) != 0)
        goto LAB80;

LAB81:    t251 = *((unsigned int *)t229);
...
LAB27:    memcpy(t130, t73, 8);

LAB28:    memset(t162, 0, 8);
    t163 = (t130 + 4);
...
LAB37:    xsi_vlog_unsigned_bit_combine(t85, 5, t100, 5, t107, 5);
    goto LAB41;

LAB39:    memcpy(t85, t100, 8);
    goto LAB41;
...
LAB104:    memcpy(t355, t334, 8);

LAB105:    memset(t387, 0, 8);
    t388 = (t355 + 4);
...
LAB114:    if (*((unsigned int *)t388) != 0)
        goto LAB115;

LAB116:    t396 = *((unsigned int *)t303);
...
LAB107:    if (*((unsigned int *)t346) != 0)
        goto LAB108;

LAB109:    t356 = *((unsigned int *)t334);
...
LAB110:    t367 = *((unsigned int *)t355);
    t368 = *((unsigned int *)t361);
    *((unsigned int *)t355) = (t367 | t368);
    t369 = (t334 + 4);
    t370 = (t348 + 4);
    t371 = *((unsigned int *)t334);
    t372 = (~(t371));
    t373 = *((unsigned int *)t369);
    t374 = (~(t373));
    t375 = *((unsigned int *)t348);
    t376 = (~(t375));
...
extern void work_m_00000000000452092752_3674845529_init()
{
	static char *pe[] = {(void *)Cont_58_0,(void *)Cont_63_1,(void *)Cont_66_2,(void *)Cont_68_3,(void *)Cont_73_4,(void *)Cont_76_5,(void *)NetDecl_80_6,(void *)Cont_82_7};
	xsi_register_didat("work_m_00000000000452092752_3674845529", "isim/mips_txt_int_isim_beh.exe.sim/work/m_00000000000452092752_3674845529.didat");
